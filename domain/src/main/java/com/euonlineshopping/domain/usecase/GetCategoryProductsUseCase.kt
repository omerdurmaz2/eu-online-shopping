...
class GetCategoryProductsUseCase @Inject constructor(
    ...
    operator fun invoke(category: String, sortBy: String?, order: String?): Flow<ProductsUiState> =
        flow {
            productsRepository.getCategoryProducts(category, sortBy, order).onSuccess { response ->
